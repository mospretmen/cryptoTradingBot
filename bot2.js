        ...
        (async function data() {
            ...
            if (+ticks[99][4] < lower && +rsi < 38 && bollingerSpread < bolSpreadParameter) {
                ...
                setTimeout(function() {
                    ...
                    binance.buy("XRPETH", qtyTrade1, Number(result.bidAsk.bidPrice) + +0.000001);
                ...
                setTimeout(function() {
                    ...
                    binance.buy("XRPETH", qtyTrade1 * 3, Number(result.bidAsk.bidPrice) + +0.00001);
                }, 500);
                ...
                setTimeout(function() {
                    ...
                    binance.sell("XRPETH", qtyTrade1, Number(result.bidAsk.askPrice) - +0.000001);
                ...
                setTimeout(function() {
                  console.log(colors.cyan('Reduce risk: position is almost 100% bought.'));
                    binance.sell("XRPETH", qtyTrade1 * 5, Number(result.bidAsk.askPrice) - +0.000001);
                }, 100);
